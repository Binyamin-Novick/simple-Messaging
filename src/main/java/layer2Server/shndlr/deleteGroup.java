...
public class deleteGroup extends handler{
    public deleteGroup(Gson gson, HttpServer server,  Serverlogic sl) {
        super(gson, server, MacroDef.http.deleteGroup, sl);
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        try {
            long[]res=sl.deleteGroup(body.get(http.Reqfield.token), Long.parseLong(body.get(http.Reqfield.gid)));
