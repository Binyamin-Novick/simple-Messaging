...
public class leaveGroup extends handler{
    public leaveGroup(Gson gson, HttpServer server, String path, Serverlogic sl) {
        super(gson, server, MacroDef.http.leaveGroup, sl);
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        try {
            long[]res =sl.leaveGroup(body.get(MacroDef.http.Reqfield.token), Long.parseLong(body.get(MacroDef.http.Reqfield.gid)));
